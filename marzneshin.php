...
function getuserm($username_account,$location)
{
    ...
    $url =  $durwinam_list_get['url_panel'].'/api/users/' . $username_account;
    $headers = array(
            'accept: application/json'
    );
...
function ResetUserDataUsagem($username_account,$location)
{
    $durwinam_list_get = select("durwinam_panel", "*", "name_panel", $location,"select");
    $Check_token = token_panelm($durwinam_list_get['code_panel']);
    $url =  $durwinam_list_get['url_panel'].'/api/users/' . $username_account.'/reset';
    $headers = array(
            'accept: application/json'
    );
    $req = new CurlRequest($url);
...
function revoke_subm($username_account,$location)
{
    $durwinam_list_get = select("durwinam_panel", "*", "name_panel", $location,"select");
    $Check_token = token_panelm($durwinam_list_get['code_panel']);
    $url =  $durwinam_list_get['url_panel'].'/api/users/' . $username_account.'/revoke_sub';
    $headers = array(
            'accept: application/json'
    );
    $req = new CurlRequest($url);
...
function adduserm($location,$data_limit,$username_ac,$timestamp,$name_product,$note ='',$data_limit_reset = 'no_reset')
{
    ...
    if($product['inbounds'] != null){
     $durwinam_list_get['proxies'] = $product['inbounds'];   
    }
    $Check_token = token_panelm($durwinam_list_get['code_panel']);
    $data = array(
            'service_ids' => json_decode($durwinam_list_get['proxies'],true),
    ...
    $url = $durwinam_list_get['url_panel']."/api/users";
    $headers = array(
            'accept: application/json',
...
function Get_System_Statsm($location){
    $durwinam_list_get = select("durwinam_panel", "*", "name_panel", $location,"select");
    $Check_token = token_panelm($durwinam_list_get['code_panel']);
    $url =  $durwinam_list_get['url_panel'].'/api/system/stats/users';
    $headers = array(
            'accept: application/json'
    );
    $req = new CurlRequest($url);
...
function enableuser($location,$username_account)
{
    $durwinam_list_get = select("durwinam_panel", "*", "name_panel", $location,"select");
    $Check_token = token_panelm($durwinam_list_get['code_panel']);
    $url =  $durwinam_list_get['url_panel'].'/api/users/'.$username_account.'/enable';
    $headers = array(
            'accept: application/json',
            'Content-Type: application/json'
    );
...
function disableduser($location,$username_account)
{
    $durwinam_list_get = select("durwinam_panel", "*", "name_panel", $location,"select");
    $Check_token = token_panelm($durwinam_list_get['code_panel']);
    $url =  $durwinam_list_get['url_panel'].'/api/users/'.$username_account.'/disable';
    $headers = array(
            'accept: application/json',
            'Content-Type: application/json'
    );
