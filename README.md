...
<p>
  <a href="https://t.me/durwinampanel">
    <img src="https://img.shields.io/badge/Telegram-Channel-2CA5E0?style=for-the-badge&logo=telegram&logoColor=white" alt="Telegram Channel"/>
  </a>
  <a href="https://t.me/durwinampanelgroup">
...
**Durwinam Bot** is a feature-rich Telegram bot for selling VPN subscriptions and automating the entire sales workflow — from purchase and payment to config creation and service management.
...
> Whether you're handing out trial accounts or running a large-scale reseller business, Durwinam Bot has the tools to run it end to end.

---

## 🧩 Supported Panels

Durwinam Bot integrates with the most popular VPN and network management panels:
...
| Command | Description |
|---------|-------------|
| `install` | Install Durwinam |
| `update` | Update Durwinam (choose channel / version) |
| `remove` | Remove Durwinam and its services |
...
durwinam install --channel auto

# Fully non-interactive install
durwinam install --name myvpnbot --token 123:ABC \
              --admin 111 --domain bot.example.com --version 0.1.7

# Update to a specific version or channel
durwinam update --version 0.1.6
durwinam update --channel release
...
📌 **Pro purchase guide:** [View on Telegram »](https://t.me/durwinamperimium/4)

---

## 🌍 Languages

Durwinam Bot ships with full translations for:
...
If **Durwinam Bot** helps your business, please consider supporting its development with a crypto donation:
...
Thanks to everyone who has contributed to making Durwinam Bot better:

<a href="https://github.com/mahdiMGF2/durwinambot/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=mahdiMGF2/durwinambot" alt="Contributors"/>
</a>
...
**Made with ❤️ by the Durwinam Panel community**

💬 [Channel](https://t.me/durwinampanel) · 👥 [Group](https://t.me/durwinampanelgroup) · ⭐ [Star on GitHub](https://github.com/mahdiMGF2/durwinambot)
