...
function get_Clients_ui($username, $namepanel)
{
    ...
    $curl = curl_init();
    $url = $durwinam_list_get['url_panel'] . '/apiv2/clients';
    curl_setopt_array($curl, array(
        ...
        CURLOPT_HTTPHEADER => array(
            'Token: ' . $durwinam_list_get['password_panel']
        ),
...
function GetClientsS_UI($username, $namepanel)
{
    ...
    $curl = curl_init();
    curl_setopt_array($curl, array(
        CURLOPT_URL => $durwinam_list_get['url_panel'] . '/apiv2/clients?id=' . $userdata['id'],
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_ENCODING => '',
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT_MS => 4000,
...
function addClientS_ui($namepanel, $usernameac, $Expire, $Total, $inboundid, $note)
{
    ...
    $curl = curl_init();
    curl_setopt_array($curl, array(
        CURLOPT_URL => $durwinam_list_get['url_panel'] . '/apiv2/save',
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_ENCODING => '',
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT_MS => 4000,
...
function get_onlineclients_ui($name_panel, $username)
{
    ...
    $curl = curl_init();
    curl_setopt_array($curl, array(
        CURLOPT_URL => $durwinam_list_get['url_panel'] . '/apiv2/onlines',
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_ENCODING => '',
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT_MS => 4000,
...
function get_settig($name_panel)
{
    ...
    $curl = curl_init();
    curl_setopt_array($curl, array(
        CURLOPT_URL => $durwinam_list_get['url_panel'] . '/apiv2/settings',
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_ENCODING => '',
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT_MS => 4000,
