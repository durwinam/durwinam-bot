...
{
    $durwinam_list_get = select("durwinam_panel", "*", "name_panel", $namepanel, "select");
    $curl = curl_init();
    curl_setopt_array($curl, array(
        CURLOPT_URL => $durwinam_list_get['url_panel'] . '/api/getWireguardConfigurationInfo?configurationName=' . $durwinam_list_get['inboundid'],
        ...
        CURLOPT_HTTPHEADER => array(
            ...
            'wg-dashboard-apikey: ' . $durwinam_list_get['password_panel']
        ),
    ));
...
function ipslast($namepanel)
{
    ...
    $durwinam_list_get = select("durwinam_panel", "*", "name_panel", $namepanel, "select");
    $url = $durwinam_list_get['url_panel'] . '/api/getAvailableIPs/' . $durwinam_list_get['inboundid'];
    $headers = array(
        'Accept: application/json',
        'wg-dashboard-apikey: ' . $durwinam_list_get['password_panel']
    );
...
function downloadconfig($namepanel, $publickey)
{
    ...
    $durwinam_list_get = select("durwinam_panel", "*", "name_panel", $namepanel, "select");
    $url = $durwinam_list_get['url_panel'] . "/api/downloadPeer/{$durwinam_list_get['inboundid']}?id=" . urlencode($publickey);
    $headers = array(
        'Accept: application/json',
        'wg-dashboard-apikey: ' . $durwinam_list_get['password_panel']
    );
...
function addpear($namepanel, $usernameac)
{
    ...
    $url = $durwinam_list_get['url_panel'] . '/api/addPeers/' . $durwinam_list_get['inboundid'];
    $headers = array(
        'Accept: application/json',
...
function setjob($namepanel, $type, $value, $publickey)
{
    ...
    $data = json_encode(array(
        "Job" => array(
            "JobID" => generateUUID(),
            "Configuration" => $durwinam_list_get['inboundid'],
            "Peer" => $publickey,
            "Field" => $type,
            "Operator" => "lgt",
            "Value" => strval($value),
    ...
    $url = $durwinam_list_get['url_panel'] . '/api/savePeerScheduleJob';
    $headers = array(
        'Accept: application/json',
        'wg-dashboard-apikey: ' . $durwinam_list_get['password_panel'],
        'Content-Type: application/json',
...
function updatepear($namepanel, array $config)
{
    ...
    $url = $durwinam_list_get['url_panel'] . '/api/updatePeerSettings/' . $durwinam_list_get['inboundid'];
    $headers = array(
        'Accept: application/json',
        'wg-dashboard-apikey: ' . $durwinam_list_get['password_panel']
    );
...
function deletejob($namepanel, array $config)
{
    ...
    $durwinam_list_get = select("durwinam_panel", "*", "name_panel", $namepanel, "select");
    $configpanel = json_encode($config);
    $url = $durwinam_list_get['url_panel'] . '/api/deletePeerScheduleJob';
    $headers = array(
        'Accept: application/json',
        'wg-dashboard-apikey: ' . $durwinam_list_get['password_panel'],
        'Content-Type: application/json',
...
function ResetUserDataUsagewg($publickey, $namepanel)
{
    ...
    $configpanel = json_encode($config, true);
    $url = $durwinam_list_get['url_panel'] . '/api/resetPeerData/' . $durwinam_list_get['inboundid'];
    $headers = array(
        'Accept: application/json',
        'wg-dashboard-apikey: ' . $durwinam_list_get['password_panel'],
        'Content-Type: application/json',
...
function remove_userwg($location, $username)
{
    ...
    $url = $durwinam_list_get['url_panel'] . '/api/deletePeers/' . $durwinam_list_get['inboundid'];
    $headers = array(
        'Accept: application/json',
        'wg-dashboard-apikey: ' . $durwinam_list_get['password_panel'],
        'Content-Type: application/json',
...
function allowAccessPeers($location, $username)
{
    ...
    $durwinam_list_get = select("durwinam_panel", "*", "name_panel", $location, "select");
    $data_user = json_decode(select("invoice", "user_info", "username", $username, "select")['user_info'], true)['public_key'];
    $url = $durwinam_list_get['url_panel'] . '/api/allowAccessPeers/' . $durwinam_list_get['inboundid'];
    $headers = array(
        'Accept: application/json',
        'wg-dashboard-apikey: ' . $durwinam_list_get['password_panel'],
        'Content-Type: application/json',
...
function restrictPeers($location, $username)
{
    ...
    $curl = curl_init();
    curl_setopt_array($curl, array(
        CURLOPT_URL => $durwinam_list_get['url_panel'] . '/api/restrictPeers/' . $durwinam_list_get['inboundid'],
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_ENCODING => '',
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 0,
